...
The argument values `WELLS_MSW` and `WELL2`, specify the package names to be printed in the water budget .lst file. In the configuration file, you have to specify which package name is used for the coupling.
