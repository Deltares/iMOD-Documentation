...
(@) Switch the dataset on and off with a click on the (![](figures/tutorial/viewer/button_3Dtool-switchon.png){width=4%}) button in file overview, left of the layer. See the underlaying rivers.
