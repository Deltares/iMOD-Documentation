---
title: Install iMOD Viewer with the installer
---

To install the iMOD Viewer components (3D Viewer & QGIS plugin),
download the installer [via this
link](https://download.deltares.nl/en/download/imod-suite/). If the
...
recommend downloading a QGIS version \> 3.18 here. After downloading the QGIS
setup, run it.
