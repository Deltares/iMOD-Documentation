...
description: 'Couple Modflow 6 to other model codes.'
---
...
The example of `imod_coupler` with the coupling between MODFLOW 6 and
the unsaturated zone model MetaSWAP can be found on:
