...
listing:
    ...
    contents:
      ...
      - path: tutorial_3_Import_modeldata_and_analysis.ipynb 
        title: "Import and edit MODFLOW 6 modeldata and analysis"
        image: figures\tutorial\hondsrug\river_clean.png 
        description: "In this example, you will learn how to use iMOD Python for building, running
