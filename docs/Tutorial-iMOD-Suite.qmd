...
![Three model layers coloured by permeability in the iMOD cross-section tool\label{figure_CrossSectionTool-3layers}](figures/figure_CrossSectionTool-3layers.png){width=100%}
...
![Calculated head with MODFLOW 6 on 3 points within the model area.\label{figure_Timeseries-Heads-in-3-points.png}](figures/figure_Timeseries-Heads-in-3-points.png){width=100%}
...
Your screen might look like Figure \ref{figure_3DViewer_headriveroverview}. 

![Top view of dataset “Calculated-Heads” and river overlay in the 3D viewer\label{figure_3DViewer_headriveroverview}](figures/figure_3DViewer_headriveroverview.png){width=100%}
