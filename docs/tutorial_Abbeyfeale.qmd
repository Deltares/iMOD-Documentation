...
(@) From the menu *Layer > Add layer > Add Mesh Layer...* load the file “Abbeyfeale\\data\\2-interim\\recharge_mesh.nc” into QGIS. 
...
(@) From the menu *Layer > Add layer > Add Mesh layer...* load the file “Abbeyfeale\\data\\2-interim\\hydrogeology_mesh.nc” into QGIS. 
